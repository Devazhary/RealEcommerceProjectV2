    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل المنتج</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <form action="{{ route('products.update', $product->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <!-- Image Upload -->
                            <div class="col-md-6 mb-4">
                                <label for="image" class="form-label">تغيير صورة المنتج</label>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <div class="image-preview" id="imagePreview"
                                    ...
                                    <div class="placeholder">
                                        ...
                                        <p class="mb-0">اضغط لاختيار صورة جديدة أو اسحبها هنا</p>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" id="description" name="description"
                                    rows="4" placeholder="أدخل وصف تفصيلي للمنتج" required>{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
